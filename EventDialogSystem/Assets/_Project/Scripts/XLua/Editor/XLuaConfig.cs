...
public static class XLuaConfig
{
    ...
    public static string GenPath = "Assets/_Project/Scripts/XLua/Gen/";
    [CSharpCallLua]
    public static List<Type> CSharpCallLua = new List<Type>()
    {
        typeof(Action<EventDialogSystem.EventSystem.DataCenter>),
        typeof(Func<EventDialogSystem.EventSystem.DataCenter, bool>)
    };
    [LuaCallCSharp]
    public static List<Type> LuaCallCSharp = new List<Type>()
    {
        typeof(EventDialogSystem.EventSystem.DataCenter)
    };
    [BlackList]
