...
namespace XLua
{
    public partial class DelegateBridge_Wrap : DelegateBridge
    {
		...
		public void __Gen_Delegate_Imp14(EventDialogSystem.EventSystem.DataCenter p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public bool __Gen_Delegate_Imp15(EventDialogSystem.EventSystem.DataCenter p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(System.Action<EventDialogSystem.EventSystem.DataCenter>))
			{
			    return new System.Action<EventDialogSystem.EventSystem.DataCenter>(__Gen_Delegate_Imp14);
			}
		
		    if (type == typeof(System.Func<EventDialogSystem.EventSystem.DataCenter, bool>))
			{
			    return new System.Func<EventDialogSystem.EventSystem.DataCenter, bool>(__Gen_Delegate_Imp15);
			}
